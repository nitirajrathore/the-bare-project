...
import { setupOpenAIProvider, setupOllamaProvider, setupMockProvider, setupGoogleProvider } from "./llm-provider";
...
// Export a function to get initialization status
export const getInitStatus = (): boolean => isInitialized;
